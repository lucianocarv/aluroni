...
export default function Items(props: Props) {
	...
	const sortPropertiesAscending = (list: typeof items, property: "size" | "serving" | "price") => {
	...
	useEffect(() => {
		const newList = items.filter(item => searchTest(item.title) && filterTest(item.category.id));
